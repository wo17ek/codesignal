/* Easy
	...
	but not this time: the performance turned out to be awfully dull. It's so bad you want to sneak out, which is quite simple, especially since the exit is located right behind your row to the left. 
...
function seatsInTheater(theaterCols, theaterRows, yourCol, yourRow) {
    return (theaterRows - yourRow) * (theaterCols - yourCol + 1);
}
